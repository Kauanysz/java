...
public class TelaPrincipal extends Janela{
	...
	public void gerarMenu() {
		...
		menu.getAccessibleContext().setAccessibleDescription("Cadastrar Usu�rios");
		menuItem.setActionCommand("Adicionar");
		menuItem.addActionListener(this);
		menu.add(menuItem);
		menu.addSeparator();
		ImageIcon icone = createImageIcon("./assets/pipoca.png");
		menuItem = new JMenuItem("Buscar" , icone);
		menu.setMnemonic(KeyEvent.VK_B);
		menuItem.getAccessibleContext().setAccessibleDescription("Buscar Usu�rios");
		menu.add(menuItem);
